...
#tf.app.flags.DEFINE_string('network', "res50", "The network to be used as backbone")
...
tf.app.flags.DEFINE_integer('max_iters', 2000, "Max iteration")#train times
...
tf.app.flags.DEFINE_integer('snapshot_iterations', 200, "Iteration to take snapshot")#save model
...
tf.app.flags.DEFINE_float('rpn_train_nms_thresh', 0.8, "NMS threshold used on RPN proposals")
